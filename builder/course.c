...
course_list *parse_entries(entry_list *e_list) {
    ...
    for(int curr_entry = 0; curr_entry < e_list->n_entries; curr_entry++) {
        ...
        block *blocks = (block *)malloc(sizeof(block) * curr_block);
    ...
    course_list *c_list = (course_list *)malloc(sizeof(course_list));
